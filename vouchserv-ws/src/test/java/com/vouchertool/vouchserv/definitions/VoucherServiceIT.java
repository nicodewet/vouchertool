...
public class VoucherServiceIT {
	...
	private final String LOCAL_WSDL = "http://localhost:8083/vouchserv/vouchserv.wsdl";
	
	@Test
	public void test() {
		URL url = null;
		try {
			// important to use LOCAL_WSDL here as this test will be a basic test
			// of our web service implementation
			url = new URL(LOCAL_WSDL);
